const AboutTimeSlot = () => {
  return (
    <div className="flex flex-col-reverse md:flex-row min-h-screen justify-center mt-20">
      ...
      <div className="flex flex-col w-full h-155 bg-amber-900/20 ">
        <div className="my-auto">
          <h1 className="text-3xl mt-10 md:text-6xl md:mt-0 flex gap-2 mb-10 ml-20 font-medium tracking-tight text-amber-50 leading-tight font-serif text-center">
            The Time Slot <br />
            <span className="text-transparent bg-clip-text bg-linear-to-r from-amber-200 to-amber-600 text-center italic">
              Café
            </span>
          </h1>
          <p className=" p-5 md:pr-60 md:ml-20 text-lg font-light">
